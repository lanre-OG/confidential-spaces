...
export PRIMUS_INPUT_STORAGE_BUCKET=${PRIMUS_INPUT_STORAGE_BUCKET:-${PRIMUS_PROJECT_ID}-input-buc}
...
export PRIMUS_WIP_PROVIDER=${PRIMUS_WIP_PROVIDER:-${PRIMUS_PROJECT_ID}-wipprov}
...
export SECUNDUS_INPUT_STORAGE_BUCKET=${SECUNDUS_INPUT_STORAGE_BUCKET:-${SECUNDUS_PROJECT_ID}-input-buc}
...
export SECUNDUS_WIP_PROVIDER=${SECUNDUS_WIP_PROVIDER:-${SECUNDUS_PROJECT_ID}-wipprov}
